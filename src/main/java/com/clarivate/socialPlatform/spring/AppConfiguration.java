package com.clarivate.socialPlatform.spring;
...
@Configuration
@ComponentScan({ "com.clarivate.socialPlatform" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.clarivate.socialPlatform");
                servletContext.setInitParameter("tapestry.development-modules", "com.clarivate.socialPlatform.services.DevelopmentModule");
