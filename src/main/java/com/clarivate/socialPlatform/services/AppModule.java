...
public class AppModule {
    ...
    public static void bind(ServiceBinder binder) {
         ...
         //binder.bind(ViewPostService.class, ViewPostServiceImpl.class);
    ...
    public static void contributeApplicationDefaults(MappedConfiguration<String, Object> configuration) {
        ...
        configuration.add(SymbolConstants.HMAC_PASSPHRASE, "change this immediately-" + 12345);

        configuration.add(SymbolConstants.ENABLE_PAGELOADING_MASK, Boolean.FALSE);
        configuration.add(SymbolConstants.ENABLE_HTML5_SUPPORT, Boolean.TRUE);
        configuration.add(SymbolConstants.START_PAGE_NAME, "About.java");
    }
